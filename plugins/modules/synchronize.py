...
options:
  ...
  use_ssh_args:
    description:
      ...
      - In Ansible 2.11 and onwards, it uses SSH connection configurations.
      - Setting this to C(yes) will also make M(ansible.posix.synchronize) use C(ansible_ssh_common_args).
    type: bool
    default: no
